...
?>
  		<div class="card">
            <div class="card-body">
			  ...
			  <a href="manage_category" class="add_link">Add Category</a>
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
						...
						<tr>
							...
							<td>
								<a href="manage_category?id=<?php echo $row['id']?>"><label class="badge badge-success hand_cursor">Edit</label></a>&nbsp;
								<?php
								if($row['status']==1){
								?>
